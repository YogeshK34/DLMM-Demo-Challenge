...
var address$2 = "EZoLi7fVCWjns7ukzjggSeDpG2GEGJbGs3MTRxAE29d4";
var metadata$2 = {
	name: "liquidity_book",
	version: "0.1.0",
	spec: "0.1.0",
...
var address$3 = "GPeBPLGzkxsdqTLw1pBjtiDMbk7xF88V1eokjfZNsFky";
var metadata$3 = {
	name: "rewarder_hook",
	version: "0.1.0",
	spec: "0.1.0",
...
var LiquidityBookAbstract = function LiquidityBookAbstract(config) {
  ...
  this.connection = new web3_js.Connection(((_config$options = config.options) == null ? void 0 : _config$options.rpcUrl) || CONFIG[config.mode].rpc, ((_config$options2 = config.options) == null ? void 0 : _config$options2.commitmentOrConfig) || "confirmed");
  var provider = new anchor.AnchorProvider(this.connection, {}, anchor.AnchorProvider.defaultOptions());
  this.mode = config.mode;
  if (config.mode === exports.MODE.DEVNET) {
    this.lbProgram = new anchor.Program(LiquidityBookIDLDevnet, provider);
    this.hooksProgram = new anchor.Program(MdmaIDLDevnet, provider);
  } else {
...
var LiquidityBookServices = /*#__PURE__*/function (_LiquidityBookAbstrac) {
  ...
  return _createClass(LiquidityBookServices, [{
    key: "lbConfig",
    get: function get() {
      if (this.mode === exports.MODE.DEVNET) {
        return new web3_js.PublicKey("DK6EoxvbMxJTkgcTAYfUnKyDZUTKb6wwPUFfpWsgeiR9");
      }
    ...
    get: function get() {
      if (this.mode === exports.MODE.DEVNET) {
        return new web3_js.PublicKey("2uAiHvYkmmvQkNh5tYtdR9sAUDwmbL7PjZcwAEYDqyES");
      }
